...
## Data Collection
The `training_data.csv` and `testing_data.csv` are provided. Aside from the given **open-high-low-close**, I add additional one-hot encoded features to provide the information of **holding** or **shorting** stock.
